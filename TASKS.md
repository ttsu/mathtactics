...
| # | Task | Layer | Depends on | Status |
|---|---|---|---|---|
| 28 | [Difficulty data, overlay & RunState](tasks/28-difficulty-data.md) | sim / data | — | Not Started |
| 29 | [New Game picker & Settings](tasks/29-difficulty-picker.md) | ui / state | 28 | Not Started |
| 30 | [Per-mode leftover bands](tasks/30-difficulty-balance.md) | data / tests | 28 | Not Started |
