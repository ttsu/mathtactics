...
Playtest 3: fun but too easy. Waves 4–7 get a HP bump (one teaching trait on 4/6/7; wave 5
stays all `basic`, grill A). A clean 7-wave run still ends at 80–100 HP. Waves 8–9 do the
real chipping (10-wave leftover min near 40, median 50–70). The Boss is untraited (100–150
HP, grill A). Wave 10 escort is T1 one + T7 two. Leaking the Boss is a loss. A sloppy run
can lose on 8–9 and never see the Boss. Waves 8–9 may spawn `basic`; wave 9 has more robots
than 8 (four at once **and** an extra pack). Waves 1–3 unchanged. Armor is **deferred to
v1.1+**.
